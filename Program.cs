...
namespace EasyTwitterPost
{
    class MainClass
    {
        //Twitter API for single user OAUTH
        ...
        public static void Main(string[] args)
        {
            ...
            callTwitter(_consumerKey, _consumerKeySecret, _accessToken, _accessTokenSecret).Wait();


            //var twitter = new TwitterApi(_consumerKey, _consumerKeySecret, _accessToken, _accessTokenSecret);
            //var response = await twitter.Tweet("This is my first automated tweet!");
            //Console.WriteLine(response);
        }

        public static async Task callTwitter(string conskey, string consKeySec, string accToken, string accTokenSec)
        {

            var twitter = new TwitterApi(conskey, consKeySec, accToken, accTokenSec);
            var response = await twitter.Tweet("This is my first automated tweet!");
            Console.WriteLine(response);
        }
